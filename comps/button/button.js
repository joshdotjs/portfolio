...
export default function Button({ variant, color, href, onClick=()=>{}, className, children, style=true }) {
  ...
  // style === false => zero styles => used for page transition with a-tags
  ...
  const styles = { cursor: 'pointer' }; // always want a pointer on hover, even when not styling
